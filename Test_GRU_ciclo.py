# -*- coding: utf-8 -*-
"""
Created on Mon Sep 23 10:55:24 2024
...
# Carica i migliori iperparametri una sola volta
with open('best_hyperparameters.json', 'r') as f:
    best_params = json.load(f)

# Inizializza il modello e carica i pesi una sola volta
...
# Lista per salvare i valori del MAE
mae_list = []

# Eseguire 1000 simulazioni
...
# Dopo tutte le simulazioni, plot dell'istogramma dei MAE
plt.figure(figsize=(10, 6))
plt.hist(mae_list, bins=50, color='skyblue', edgecolor='black')
plt.title('Distribuzione del MAE su 1000 Simulazioni')
plt.xlabel('MAE (%)')
...
print(f"Media MAE: {mae_array.mean():.2f}%")
print(f"Deviazione Standard MAE: {mae_array.std():.2f}%")
print(f"Valore MAE Minimo: {mae_array.min():.2f}%")
print(f"Valore MAE Massimo: {mae_array.max():.2f}%")